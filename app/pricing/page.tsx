...
export const metadata: Metadata = {
  ...
  description: 'Choose the best creative plan for your visual pipeline. Flexible pricing for creators, professionals, and enterprises.',
}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
          <div className="flex items-center gap-8">
            ...
            <nav className="hidden md:flex items-center gap-6 text-sm font-medium text-slate-400">
              ...
              <Link href="/pricing" className="text-slate-100 font-semibold transition-colors">Pricing</Link>
              <Link href="/search-engine" className="hover:text-slate-100 transition-colors">AI Search</Link>
            </nav>
          </div>
          <div className="flex items-center gap-4">
            <Link href="/studio" className="inline-flex items-center justify-center px-4 py-2 rounded-lg text-sm font-semibold text-white bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 transition-all">
              Launch Studio
            </Link>
          </div>
        </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        ...
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-slate-400 text-lg sm:text-xl">
            Whether you generate simple assets or produce high-fidelity studio cinematic campaigns, we have a plan for you.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto mb-24">
          ...
          <div className="rounded-2xl border border-slate-900 bg-slate-950 p-8 flex flex-col justify-between hover:border-slate-800 transition-all">
            <div>
              ...
              <p className="text-sm text-slate-400 mb-6">Explore basic creative generative tools.</p>
              ...
              <ul className="space-y-4 text-sm text-slate-400">
                <li className="flex items-center gap-2.5">
                  <svg className="w-4 h-4 text-violet-500 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>
                ...
                <li className="flex items-center gap-2.5">
                  <svg className="w-4 h-4 text-slate-600 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}><path strokeLinecap="round" strokeLinejoin="round" d="M6 18L18 6M6 6l12 12" /></svg>
            ...
            <Link href="/studio" className="mt-8 block w-full text-center px-4 py-3 rounded-xl text-sm font-semibold border border-slate-800 hover:border-slate-700 text-slate-300 hover:text-white bg-slate-900/40 hover:bg-slate-900 transition-all">
              Launch Studio Free
            </Link>
          </div>
          ...
          <div className="rounded-2xl border-2 border-violet-500 bg-slate-900/30 p-8 flex flex-col justify-between shadow-[0_0_30px_rgba(124,58,237,0.15)] relative scale-105">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400 mb-6">Designed for filmmakers, designers, and creators.</p>
              <div className="flex items-baseline text-slate-100 mb-8">
              ...
              <ul className="space-y-4 text-sm text-slate-200">
                <li className="flex items-center gap-2.5">
                  <svg className="w-4 h-4 text-violet-400 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={3}><path strokeLinecap="round" strokeLinejoin="round" d="M5 13l4 4L19 7" /></svg>
            ...
            <Link href="/studio?tier=pro" className="mt-8 block w-full text-center px-4 py-3.5 rounded-xl text-sm font-semibold text-white bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-500 hover:to-indigo-500 transition-all shadow-lg shadow-violet-600/20 active:scale-95">
              Subscribe to Pro
            </Link>
          </div>
          ...
          <div className="rounded-2xl border border-slate-900 bg-slate-950 p-8 flex flex-col justify-between hover:border-slate-800 transition-all">
            <div>
              ...
              <h2 className="text-2xl font-bold text-slate-100 mb-2">Business</h2>
              <p className="text-sm text-slate-400 mb-6">Unrestricted rendering power for production teams.</p>
              <div className="flex items-baseline text-slate-100 mb-8">
            ...
            <Link href="/studio?tier=business" className="mt-8 block w-full text-center px-4 py-3 rounded-xl text-sm font-semibold border border-slate-800 hover:border-slate-700 text-slate-300 hover:text-white bg-slate-900/40 hover:bg-slate-900 transition-all">
          ...
          <div className="border border-slate-900 rounded-2xl bg-slate-950/50 backdrop-blur-sm overflow-hidden">
            <table className="w-full text-left border-collapse text-sm">
              ...
              <tbody className="divide-y divide-slate-900 text-slate-400">
                <tr>
                  <td className="p-4 text-slate-200 font-medium">Monthly credits</td>
                  <td className="p-4">10</td>
                  <td className="p-4 text-violet-400 font-semibold">2,000 (Fast)</td>
                  <td className="p-4 text-cyan-400 font-semibold">Unlimited</td>
                </tr>
                <tr>
                  <td className="p-4 text-slate-200 font-medium">Max resolution</td>
                  <td className="p-4">720p</td>
                  <td className="p-4">4K Cinematic</td>
                  <td className="p-4">8K (Upscaled)</td>
                </tr>
                <tr>
                  <td className="p-4 text-slate-200 font-medium">Frames-to-Video models</td>
                  <td className="p-4">Flux Schnell</td>
                  <td className="p-4">Runway Gen-4 + Kling</td>
                  <td className="p-4">Runway Gen-4 + Kling + Sora</td>
                </tr>
                <tr>
                  <td className="p-4 text-slate-200 font-medium">Character locking</td>
                  <td className="p-4">No</td>
                  <td className="p-4">Yes</td>
                  <td className="p-4">Yes (Custom upload)</td>
                </tr>
                <tr>
                  <td className="p-4 text-slate-200 font-medium">Team collaboration</td>
                  <td className="p-4">No</td>
        ...
        <section className="max-w-3xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="p-6 rounded-xl border border-slate-900 bg-slate-950">
              <h3 className="font-bold text-slate-200 mb-2">Do I own the copyrights to the generated files?</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
                Yes. Any assets generated through the VortexLogic studio on paid plans (Pro and Business) are 100% owned by you for both commercial and non-commercial utilization.
              </p>
            </div>
            <div className="p-6 rounded-xl border border-slate-900 bg-slate-950">
              <h3 className="font-bold text-slate-200 mb-2">Can I cancel my subscription anytime?</h3>
              <p className="text-sm text-slate-400 leading-relaxed">
                Absolutely. You can cancel your monthly subscription at any time with a single click inside the Studio dashboard billing settings.
              </p>
            </div>
          </div>
        </section>
